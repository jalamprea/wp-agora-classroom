...
<div id="sidebar-container" class="sidebar-expanded"><!-- d-* hiddens the Sidebar in smaller devices. Its itens can be kept on the Navbar 'Menu' -->
    ...
    <ul class="list-group">
        ...
        <a id="exit-btn" href="#exit" class="bg-info list-group-item list-group-item-action flex-column align-items-start d-flex" title="Finish Call">
            <div class="w-100 justify-content-start align-items-center">
        ...
        <a id="screen-share-btn" href="#" class="bg-dark list-group-item list-group-item-action d-flex only-main-host" title="Screen Share">
            <div class="w-100 justify-content-start align-items-center">
